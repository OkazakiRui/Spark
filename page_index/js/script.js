$(function () {
      ...
      setTimeout(() => {
        ...
        if (firekind == 2) {
          audioElement2.setAttribute(
            'src',
            '../page_room/sound/fireworks-star.mp3'
          );
          audioElement2.play();
          ...
          audioElement3.setAttribute(
            'src',
            '../page_room/sound/fireworks-bubble.mp3'
          );
          audioElement3.play();
  ...
  const soundbird1 = function () {
    ...
    for (let i = 0; i < birdNum; i++) {
      ...
      $(
        `<img src="../page_room/effect_img/chicken3.gif" alt="雷" class="gif" style="width:${randomWidth}px; height:auto; opacity:0.7; position:absolute; transform:translate(-50%,-50%); bottom:-30%; left:${randomLeft}%; opacity:1;">`
      ).appendTo('#gifBox');
